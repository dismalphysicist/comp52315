...
# 1 "/ddn/apps/Cluster-Apps/intel/2019.5/compilers_and_libraries_2019.5.281/linux/compiler/include/omp.h" 1 3
...
# 64 "/ddn/apps/Cluster-Apps/intel/2019.5/compilers_and_libraries_2019.5.281/linux/compiler/include/omp.h" 3
...
# 159 "/ddn/apps/Cluster-Apps/intel/2019.5/compilers_and_libraries_2019.5.281/linux/compiler/include/omp.h" 2 3
# 1 "/ddn/apps/Cluster-Apps/intel/2019.5/compilers_and_libraries_2019.5.281/linux/compiler/include/stdint.h" 1 3
...
# 160 "/ddn/apps/Cluster-Apps/intel/2019.5/compilers_and_libraries_2019.5.281/linux/compiler/include/omp.h" 2 3
...
# 307 "/ddn/apps/Cluster-Apps/intel/2019.5/compilers_and_libraries_2019.5.281/linux/compiler/include/omp.h" 3
...
void Comm::exchange(Atom &atom)
{
  ...
  for(idim = 0; idim < 3; idim++) {
    ...
    #pragma omp master
    {
      ...
      MPI_Sendrecv(&nsend, 1, ((MPI_Datatype)0x4c000405), procneigh[idim][0], 0,
                   &nrecv1, 1, ((MPI_Datatype)0x4c000405), procneigh[idim][1], 0,
                   ((MPI_Comm)0x44000000), (MPI_Status *)1);
      nrecv = nrecv1;

      if(procgrid[idim] > 2) {
        MPI_Sendrecv(&nsend, 1, ((MPI_Datatype)0x4c000405), procneigh[idim][1], 0,
                     &nrecv2, 1, ((MPI_Datatype)0x4c000405), procneigh[idim][0], 0,
                     ((MPI_Comm)0x44000000), (MPI_Status *)1);
        nrecv += nrecv2;
      }
  ...
  for(idim = 0; idim < 3; idim++) {
    ...
    for(int ineed = 0; ineed < 2 * need[idim]; ineed += 1) {
      if(ineed < procgrid[idim] - 1) {
        MPI_Sendrecv(&nsend, 1, ((MPI_Datatype)0x4c000405), sendproc_exc[iswap], 0,
                     &nrecv, 1, ((MPI_Datatype)0x4c000405), recvproc_exc[iswap], 0,
                     ((MPI_Comm)0x44000000), (MPI_Status *)1);
  ...
  for(idim = 0; idim < 3; idim++) {
    ...
    for(ineed = 0; ineed < 2 * need[idim]; ineed++) {
      ...
      #pragma omp master
      {
        ...
        if(sendproc[iswap] != me) {
          MPI_Sendrecv(&nsend, 1, ((MPI_Datatype)0x4c000405), sendproc[iswap], 0,
                       &nrecv, 1, ((MPI_Datatype)0x4c000405), recvproc[iswap], 0,
                       ((MPI_Comm)0x44000000), (MPI_Status *)1);
